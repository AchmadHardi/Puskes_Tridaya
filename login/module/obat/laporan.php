                    ...
                    <div class="card-body">
                        <div class="table-responsive p-t-10">
                            <table id="example" class="table   " style="width:100%">
                                ...
                                <tbody>
                                    <?php $query=mysqli_query($conn,"SELECT * from barang order by stok asc");$no=1; ?>
                                    <?php 
                                    foreach ($query as $row): 
                                        ...
                                        <tr>
                                            ...
                                            <td><span><?php echo $row['stok']; ?></span></td>
                                            <td><?php if($row['stok'] < 100){ ?><small class="badge badge-sm badge-danger">Stok mau habis</small><?php } ?></td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
                            </table>
