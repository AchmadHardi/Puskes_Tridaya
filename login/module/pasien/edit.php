...
$edit=mysqli_fetch_array(mysqli_query($conn,"SELECT * from customer where id='$_GET[id]'"));
?>
                        ...
                        <form action="<?php echo $aksi ?>?module=<?php echo $_GET['module'] ?>&act=<?php echo $_GET['act'] ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xs-12 form-group">
                                    ...
                                    <input type="text" name="nama_customer" class="form-control" value="<?php echo $edit['nama_customer'] ?>" >
                                </div>
                                <div class="col-md-12 col-xs-12 form-group">
                                    <label>Telpon</label>
                                    <input type="tel" name="tel" class="form-control" value="<?php echo $edit['tel'] ?>" >
                                </div>
                                <div class="col-md-12 col-xs-12 form-group">
                                    <label>Alamat</label>
