                    ...
                    <div class="card-body">
                        <div class="table-responsive p-t-10">
                            <table id="example" class="table   " style="width:100%">
                                ...
                                <tbody>
                                    <?php $query=mysqli_query($conn,"SELECT * from customer order by id desc"); $no=1; ?>
                                    <?php foreach ($query as $row): ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $row['nama_customer']; ?><br><small class="text-muted"><?php echo $row['alamat'] ?></small></td>
