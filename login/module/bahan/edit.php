...
$edit=mysqli_fetch_array(mysqli_query($conn,"SELECT * from bahan where id='$_GET[id]'"));
?>
                        ...
                        <form action="<?php echo $aksi ?>?module=<?php echo $_GET['module'] ?>&act=<?php echo $_GET['act'] ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xs-12 form-group">
                                    ...
                                    <input type="text" name="nama_bahan" class="form-control" value="<?php echo $edit['nama_bahan'] ?>" >
                                </div>
                                <div class="col-md-12 col-xs-12 form-group">
                                    <label>Satuan </label>
                                    <input type="text" name="satuan" class="form-control" value="<?php echo $edit['satuan'] ?>" >
                                </div>
                                <div class="col-md-12 col-xs-12 form-group">
