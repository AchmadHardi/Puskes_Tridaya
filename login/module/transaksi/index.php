                            ...
                            <tbody>
                                ...
                                foreach($query as $row){
                                    ...
                                    <tr>
                                        ...
                                        <td hidden>Rp <?php echo number_format($sum,0,',','.'); ?></td>
                                        <td>
                                            <?php if($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'petugas'){ ?>
                                            <a href="<?php echo $aksi; ?>?module=<?php echo $_GET['module'] ?>&act=delete&id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');" title="Hapus"><i class="mdi mdi-delete"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
